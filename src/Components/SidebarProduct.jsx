  ...
  return (
    <div className="">
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="h-full px-4 py-4 overflow-y-auto bg-[#828282]">
          ...
          <div className="flex items-center justify-center m-auto -mt-5">
            <ul className="flex-col gap-10">
              <li className="absolute flex items-center justify-center inset-x-0 mt-16">
                <button
                  type="button"
                  className="w-[80%] p-3 flex gap-4 text-start justify-start items-center text-sm font-medium rounded-lg  bg-white"
                >
                  <svg
                    width="29"
                    height="29"
