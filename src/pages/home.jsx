...
const Home = () => {
  const [products] = useState([
    { id: 1, image:"Images/item1.png", name: "Samsung Galaxy S23 Ultra", price: 20999000 },
    { id: 2, image:"Images/item2.jpg", name: "Samsung Galaxy A52", price: 4999000 },
  ]);
            ...
            {products.map((product) => (
              ...
              >
                ...
                <div className="teks">
                  ...
                  <div className="price text-[11px] font-regular">
                    {product.price}
                  </div>
                </div>
                <div className="btn flex justify-end mt-2">
                  <button
                    className="btn text-[11px] text-white bg-[#9B9B9B] rounded p-2"
        ...
        <div className="right w-[30%] px-3 flex items-center justify-center ">
          <div className="keranjang produk bg-white h-[95%] w-full rounded-lg p-2 py-3 flex flex-col justify-between shadow-lg">
            ...
            <div className="bottom ">
              ...
              <button className="bg-[#9B9B9B] text-white w-full p-2 rounded-lg">Checkout</button>
            </div>
          </div>
        </div>
      </div>
